...
=head1 FUNCTIONS
  ...
  Rmpc_swap($op1, $op2);
   ...
   OPERATOR OVERLOADING
    ...
    NOTE: This means that (eg) 5/$obj is different to "5"/obj,
      because the former divides the IV 5 by $obj, whereas the
      latter divides the complex number (5 + 0i) by $obj - and this
      can make a difference to the sign of the imaginary component
      of the quotient.
