...
=head1 FUNCTIONS
  ...
  (which calls 'Rmpc_clear') is automatically called on blessed
   ...
   $si = Rmpc_agm ($rop, $op1, $op2, $rnd); # mpc-1.3.0 &
    ...
    rounded according to $rnd with the precision of $rop.  Concerning
    the branch cut, the function is computed by homogeneity either as:
    1) $op1 AGM(1,b0) with b0=$op2/$op1 if |A|>=|B|
       or, otherwise, as:
    2) $op2 AGM(1,b0) with b0=$op1/$op2.
...
=head1 LICENSE
    ...
    Copyright 2006-2011, 2014, 2016, 2018, 2020 Sisyphus
